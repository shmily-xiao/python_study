...
class SearchTicket(object):
    ...
    def get_all_location_stock(self, ticket, date_time):
        ...
        for index, location in enumerate(locations):
            ...
            if index == 0:
                locations_name.append(from_location)

            to_location = locations[index + 1].get("station_name")
            locations_name.append(to_location)
        ...
        data = {"train_no": train_no, "real_name": ticket.get("queryLeftNewDTO").get("station_train_code"),
                "data": result_location, "locations_name":locations_name}
...
if __name__ == '__main__':
    ...
    data = [
        {"data": [{"to_station": "涿州", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
                       "from_station": "北京西"}, {"to_station": "高碑店",
                                                "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有",
                                                                "软卧": "20"}, "from_station": "涿州"},
                      {"to_station": "保定", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
                       "from_station": "高碑店"}, {"to_station": "定州",
                                                "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有",
                                                                "软卧": "20"}, "from_station": "保定"},
                      {"to_station": "石家庄",
                       "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
                       "from_station": "定州"}, {"to_station": "邢台",
                                               "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有",
                                                               "软卧": "20"}, "from_station": "石家庄"},
                      {"to_station": "安阳", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
                       "from_station": "邢台"},
                      {"to_station": "汤阴", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
                       "from_station": "安阳"}, {"to_station": "鹤壁",
                                               "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有",
                                                               "软卧": "20"}, "from_station": "汤阴"}, {"to_station": "郑州",
                                                                                                    "left_ticket": {
                                                                                                        "无座": "有",
                                                                                                        "hasSeat": True,
                                                                                                        "硬卧": "有",
                                                                                                    ...
                                                                                                    "from_station": "鹤壁"},
                      {"to_station": "洛阳",
                       "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "20"},
                       "from_station": "郑州"}, {"to_station": "渑池",
                                               "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有",
                                                               "软卧": "20"}, "from_station": "洛阳"}, {"to_station": "三门峡",
                                                                                                    "left_ticket": {
                                                                                                        "无座": "有",
                                                                                                        "hasSeat": True,
                                                                                                        "硬卧": "有",
                      ...
                      {"to_station": "渭南",
                       "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "20"},
                       "from_station": "三门峡"}, {"to_station": "安康",
                                                "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有",
                                                                "软卧": "20"}, "from_station": "渭南"}, {"to_station": "达州",
                                                                                                     "left_ticket": {
                                                                                                         "无座": "有",
                                                                                                         "hasSeat": True,
                                                                                                         "硬卧": "有",
                                                                                                         ...
                                                                                                         "软卧": "20"},
                                                                                                     "from_station": "安康"},
                      {"to_station": "渠县", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
                       "from_station": "达州"}, {"to_station": "广安",
                                               "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有",
                                                               "软卧": "20"}, "from_station": "渠县"}, {"to_station": "重庆北",
                                                                                                    "left_ticket": {
                                                                                                        "无座": "有",
                                                                                                        "hasSeat": True,
                                                                                                        "硬卧": "有",
                                                                                                        ...
                                                                                                        "软卧": "20"},
                                                                                                    "from_station": "广安"}],
             "train_no": "240000K8190J", "real_name": None}, {"data": [
        {"to_station": "涿州东", "left_ticket": {"二等座": "有", "一等座": "9", "商务座": "2", "hasSeat": True},
         "from_station": "北京西"},
        {"to_station": "保定东", "left_ticket": {"二等座": "有", "一等座": "无", "商务座": "1", "hasSeat": True},
         "from_station": "涿州东"},
        {"to_station": "石家庄", "left_ticket": {"二等座": "有", "一等座": "9", "商务座": "1", "hasSeat": True},
         "from_station": "保定东"},
        {"to_station": "邯郸东", "left_ticket": {"二等座": "有", "一等座": "12", "商务座": "2", "hasSeat": True},
         "from_station": "石家庄"},
        {"to_station": "安阳东", "left_ticket": {"二等座": "有", "一等座": "13", "商务座": "3", "hasSeat": True},
         "from_station": "邯郸东"},
        {"to_station": "郑州东", "left_ticket": {"二等座": "有", "一等座": "12", "商务座": "2", "hasSeat": True},
         "from_station": "安阳东"},
        {"to_station": "汉口", "left_ticket": {"二等座": "4", "一等座": "11", "商务座": "2", "hasSeat": True},
         "from_station": "郑州东"},
        {"to_station": "仙桃西", "left_ticket": {"二等座": "有", "一等座": "7", "商务座": "1", "hasSeat": True},
         "from_station": "汉口"},
        {"to_station": "潜江", "left_ticket": {"二等座": "7", "一等座": "无", "商务座": "无", "hasSeat": True},
         "from_station": "仙桃西"},
        {"to_station": "荆州", "left_ticket": {"二等座": "有", "一等座": "12", "商务座": "1", "hasSeat": True},
         "from_station": "潜江"},
        {"to_station": "宜昌东", "left_ticket": {"二等座": "有", "一等座": "12", "商务座": "1", "hasSeat": True},
         "from_station": "荆州"},
        {"to_station": "建始", "left_ticket": {"二等座": "有", "一等座": "20", "商务座": "1", "hasSeat": True},
         "from_station": "宜昌东"},
        {"to_station": "恩施", "left_ticket": {"二等座": "11", "一等座": "无", "商务座": "无", "hasSeat": True},
         "from_station": "建始"},
        {"to_station": "利川", "left_ticket": {"二等座": "有", "一等座": "有", "商务座": "1", "hasSeat": True},
         "from_station": "恩施"},
        {"to_station": "石柱县", "left_ticket": {"二等座": "11", "一等座": "1", "商务座": "无", "hasSeat": True},
         "from_station": "利川"},
        {"to_station": "涪陵北", "left_ticket": {"二等座": "有", "一等座": "20", "商务座": "无", "hasSeat": True},
         "from_station": "石柱县"},
        {"to_station": "重庆北", "left_ticket": {"二等座": "有", "一等座": "20", "商务座": "无", "hasSeat": True},
         "from_station": "涪陵北"},
        {"to_station": "合川", "left_ticket": {"二等座": "有", "一等座": "20", "商务座": "5", "hasSeat": True},
         "from_station": "重庆北"}], "train_no": "240000G30908", "real_name": None}, {"data": [
        {"to_station": "保定", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "13"},
         "from_station": "北京西"},
        {"to_station": "石家庄", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "20", "软卧": "13"},
         "from_station": "保定"},
        {"to_station": "高邑", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "13"},
         "from_station": "石家庄"},
        {"to_station": "邢台", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "13"},
         "from_station": "高邑"},
        {"to_station": "沙河市", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "14"},
         "from_station": "邢台"},
        {"to_station": "新乡", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "13"},
         "from_station": "沙河市"},
        {"to_station": "焦作", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "14"},
         "from_station": "新乡"},
        {"to_station": "月山", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "20"},
         "from_station": "焦作"},
        {"to_station": "济源", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "月山"},
        {"to_station": "汝州", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "济源"},
        {"to_station": "平顶山西", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "20"},
         "from_station": "汝州"},
        {"to_station": "襄阳", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "20"},
         "from_station": "平顶山西"},
        {"to_station": "十堰", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "襄阳"},
        {"to_station": "白河东", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "20"},
         "from_station": "十堰"},
        {"to_station": "安康", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "20"},
         "from_station": "白河东"},
        {"to_station": "宣汉", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "20", "软卧": "有"},
         "from_station": "安康"},
        {"to_station": "达州", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "20"},
         "from_station": "宣汉"},
        {"to_station": "渠县", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "20"},
         "from_station": "达州"},
        {"to_station": "广安", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "20"},
         "from_station": "渠县"},
        {"to_station": "华蓥", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "广安"},
        {"to_station": "北碚", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "华蓥"},
        {"to_station": "重庆", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "20", "软卧": "有"},
         "from_station": "北碚"}], "train_no": "240000K5890X", "real_name": None}, {"data": [
        {"to_station": "保定", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "4", "硬座": "无", "软卧": "15"},
         "from_station": "北京西"},
        {"to_station": "石家庄", "left_ticket": {"无座": "无", "hasSeat": True, "硬卧": "3", "硬座": "1", "软卧": "4"},
         "from_station": "保定"},
        {"to_station": "郑州", "left_ticket": {"无座": "无", "hasSeat": True, "硬卧": "无", "硬座": "无", "软卧": "无"},
         "from_station": "石家庄"},
        {"to_station": "汉口", "left_ticket": {"无座": "2", "hasSeat": True, "硬卧": "无", "硬座": "无", "软卧": "无"},
         "from_station": "郑州"},
        {"to_station": "宜昌东", "left_ticket": {"无座": "无", "hasSeat": True, "硬卧": "无", "硬座": "无", "软卧": "无"},
         "from_station": "汉口"},
        {"to_station": "恩施", "left_ticket": {"无座": "13", "hasSeat": True, "硬卧": "无", "硬座": "无", "软卧": "无"},
         "from_station": "宜昌东"},
        {"to_station": "重庆北", "left_ticket": {"无座": "13", "hasSeat": True, "硬卧": "无", "硬座": "无", "软卧": "1"},
         "from_station": "恩施"},
        {"to_station": "遂宁", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "3", "软卧": "有"},
         "from_station": "重庆北"}], "train_no": "2400000Z490E", "real_name": None}, {"data": [
        {"to_station": "石家庄", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "3"},
         "from_station": "北京西"},
        {"to_station": "邢台", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "19", "硬座": "有", "软卧": "无"},
         "from_station": "石家庄"},
        {"to_station": "邯郸", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "17", "硬座": "有", "软卧": "无"},
         "from_station": "邢台"},
        {"to_station": "安阳", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "10", "硬座": "有", "软卧": "无"},
         "from_station": "邯郸"},
        {"to_station": "新乡", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "8", "硬座": "有", "软卧": "无"},
         "from_station": "安阳"},
        {"to_station": "郑州", "left_ticket": {"无座": "无", "hasSeat": True, "硬卧": "6", "硬座": "有", "软卧": "无"},
         "from_station": "新乡"},
        {"to_station": "襄阳", "left_ticket": {"无座": "无", "hasSeat": True, "硬卧": "无", "硬座": "有", "软卧": "无"},
         "from_station": "郑州"},
        {"to_station": "十堰", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "6"},
         "from_station": "襄阳"},
        {"to_station": "安康", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "13"},
         "from_station": "十堰"},
        {"to_station": "万源", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "19"},
         "from_station": "安康"},
        {"to_station": "达州", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "万源"},
        {"to_station": "渠县", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "达州"},
        {"to_station": "重庆北", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "20"},
         "from_station": "渠县"}], "train_no": "24000000T90U", "real_name": None}, {"data": [
        {"to_station": "石家庄", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "无", "硬座": "有", "软卧": "无"},
         "from_station": "北京西"},
        {"to_station": "汉口", "left_ticket": {"无座": "无", "hasSeat": True, "硬卧": "无", "硬座": "有", "软卧": "无"},
         "from_station": "石家庄"},
        {"to_station": "荆州", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "无", "硬座": "有", "软卧": "无"},
         "from_station": "汉口"},
        {"to_station": "宜昌东", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "8"},
         "from_station": "荆州"},
        {"to_station": "恩施", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "10"},
         "from_station": "宜昌东"},
        {"to_station": "重庆北", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "12"},
         "from_station": "恩施"}], "train_no": "24000000Z30I", "real_name": None}, {"data": [
        {"to_station": "石家庄", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "4"},
         "from_station": "北京西"},
        {"to_station": "郑州", "left_ticket": {"无座": "无", "hasSeat": True, "硬卧": "无", "硬座": "有", "软卧": "无"},
         "from_station": "石家庄"},
        {"to_station": "汉口", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "无", "硬座": "4", "软卧": "无"},
         "from_station": "郑州"},
        {"to_station": "宜昌东", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "1"},
         "from_station": "汉口"},
        {"to_station": "恩施", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "11"},
         "from_station": "宜昌东"},
        {"to_station": "万州", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "恩施"},
        {"to_station": "梁平", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "万州"},
        {"to_station": "达州", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "梁平"},
        {"to_station": "广安", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "达州"},
        {"to_station": "重庆北", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "广安"}], "train_no": "2400000Z9502", "real_name": None}, {"data": [
        {"to_station": "高碑店", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "8"},
         "from_station": "北京西"},
        {"to_station": "保定", "left_ticket": {"无座": "无", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "7"},
         "from_station": "高碑店"},
        {"to_station": "石家庄", "left_ticket": {"无座": "无", "hasSeat": True, "硬卧": "有", "硬座": "20", "软卧": "7"},
         "from_station": "保定"},
        {"to_station": "邢台", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "19", "硬座": "有", "软卧": "无"},
         "from_station": "石家庄"},
        {"to_station": "邯郸", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "12", "硬座": "有", "软卧": "无"},
         "from_station": "邢台"},
        {"to_station": "新乡", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "无", "硬座": "有", "软卧": "无"},
         "from_station": "邯郸"},
        {"to_station": "郑州", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "13", "硬座": "有", "软卧": "1"},
         "from_station": "新乡"},
        {"to_station": "巩义", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "10"},
         "from_station": "郑州"},
        {"to_station": "偃师", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "20", "硬座": "有", "软卧": "10"},
         "from_station": "巩义"},
        {"to_station": "汝州", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "10"},
         "from_station": "偃师"},
        {"to_station": "平顶山西", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "15"},
         "from_station": "汝州"},
        {"to_station": "南召", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "平顶山西"},
        {"to_station": "邓州", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "南召"},
        {"to_station": "襄阳", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "邓州"},
        {"to_station": "武当山", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "襄阳"},
        {"to_station": "十堰", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "武当山"},
        {"to_station": "白河东", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "十堰"},
        {"to_station": "安康", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "白河东"},
        {"to_station": "万源", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "安康"},
        {"to_station": "宣汉", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "万源"},
        {"to_station": "达州", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "宣汉"},
        {"to_station": "渠县", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
        ...
        {"to_station": "广安", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "渠县"},
        {"to_station": "重庆", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "广安"},
        {"to_station": "桐梓", "left_ticket": {"无座": "有", "hasSeat": True, "硬卧": "有", "硬座": "有", "软卧": "有"},
         "from_station": "重庆"}], "train_no": "240000K5072A", "real_name": None}]
