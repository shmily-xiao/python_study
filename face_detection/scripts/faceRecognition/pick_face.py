...
def readPicSaveFace(sourcePath,objectPath,*suffix):
    try:
        ...
        count = 1
        face_cascade = cv2.CascadeClassifier('D:\\Python\\opencv\\data\\haarcascades\\haarcascade_frontalface_alt.xml')
...
if __name__ == '__main__':
     readPicSaveFace('D:\\Python\\python_study\\face_detection\\image','D:\\Python\\python_study\\face_detection\\image\\picTest','.jpg','.JPG','png','PNG')
