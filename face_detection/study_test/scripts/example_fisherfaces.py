...
subplot(title=" Fisherfaces AT&T Facedatabase ", images=E, rows=4, cols=4, sptitle="Fisherface ", colormap=cm.jet,
...
subplot(title=" Fisherfaces Reconstruction Yale FDB ", images=EE, rows=4, cols=5, sptitle=" Fisherface",
        colormap=cm.gray, filename="python_fisherfaces_reconstruction.jpg")
