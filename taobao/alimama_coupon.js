!function(a, b) {
    ...
    function g(a) {
        try {
            return ".com" === a.substring(a.lastIndexOf(".")) ? a.substring(a.lastIndexOf(".", a.lastIndexOf(".") - 1) + 1) : (a.split(".") || []).length <= 3 ? a : a.split(".").slice(1).join(".")
        } catch (b) {
    ...
    o.prototype.__processRequestType = function(c) {
        ...
        f.H5Request === !1 && f.WindVaneRequest === !0) {
            if (!u && (!b.windvane || parseFloat(f.WindVaneVersion) < 5.4))
                throw new Error("WINDVANE_NOT_FOUND::缺少WindVane环境");
            if (u && !a.AlipayJSBridge)
        ...
        c ? c().then(function() {
            ...
            f.WindVaneRequest === !0 && u && f.retJson.error || !a || a.indexOf("PARAM_PARSE_ERROR") > -1 || a.indexOf("HY_FAILED") > -1 || a.indexOf("HY_NO_HANDLER") > -1 || a.indexOf("HY_CLOSED") > -1 || a.indexOf("HY_EXCEPTION") > -1 || a.indexOf("HY_NO_PERMISSION") > -1) {
                if (!u || !isNaN(f.retJson.error) || -1 !== f.retJson.error.indexOf("FAIL_SYS_ACCESS_DENIED"))
                    return u && i(e.data) && (e.data = JSON.stringify(e.data)),
                    r.H5Request = !0,
        ...
        c.WindVaneRequest !== !0 ? q.then(function() {
            ...
            d.indexOf("TOKEN_EMPTY") > -1 || c.CDR === !0 && d.indexOf("ILLEGAL_ACCESS") > -1 || d.indexOf("TOKEN_EXOIRED") > -1) {
                ...
                c.H5Request && ++c.failTimes < c.maxRetryTimes)
                    return b.__sequence([b.__waitWKWebViewCookie, b.__processToken, b.__processRequestUrl, b.middlewares, b.__processRequest]);
    ...
    o.prototype.__processRequest = function(a, b) {
        ...
        return q.then(function() {
            ...
            if (a.WindVaneRequest)
                return u ? c.__requestAlipay(b) : c.__requestWindVane(b);
